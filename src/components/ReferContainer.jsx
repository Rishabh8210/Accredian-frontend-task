...
const ReferContainer = () => {
  ...
  return (
    <div className='min-h-[40vh] max-w-screen flex flex-col gap-7 py-7 items-center flex-shrink-0 bg-blue-100'>
        ...
        <button className='h-12 flex-shrink-0 w-32 bg-blue-600 hover:bg-blue-800 text-white rounded-lg font-semibold' onClick={() => setReferForm(!isReferFormOpen)}>Refer Now</button>
    </div>
  )
}
