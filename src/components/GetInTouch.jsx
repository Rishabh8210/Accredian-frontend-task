...
const GetInTouch = () => {
  return (
    <div className='h-[20vh] w-screen px-32 flex items-center text-white'>
        <div className='flex items-center px-14 h-full w-full gap-8 rounded-lg bg-blue-500'>
            ...
            <div className='h-12 w-36'>
                <button className='h-full w-full bg-white text-blue-500 rounded-lg font-semibold'>Refer Now</button>
            </div>
        </div>
    </div>
  )
